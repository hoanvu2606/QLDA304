...
<div class="form-group">
					...
					<input type="text" name="docname" class="form-control"  placeholder="">
														</div>
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder=""></textarea>
														</div>
<div class="form-group">
															<label for="fess">
																 Chi phí
															</label>
					<input type="text" name="docfees" class="form-control"  placeholder="">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control"  placeholder="">
														</div>
...
<div class="form-group">
					...
					<input type="email" name="docemail" class="form-control"  placeholder="">
														</div>
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="" required="required">
														</div>
